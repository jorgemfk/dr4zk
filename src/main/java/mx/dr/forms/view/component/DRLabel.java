 ...
 *
 * <br/>
 * Anotacion que define el comportamiento de un componente label
 * @author Jorge Luis Martinez Ramirez
 * @version 1.0
 * @since 13/08/2012
 * @since v0.5
...
@DRRender(itemRenderer=DRLabelRender.class)
public @interface DRLabel {
    /**
	* define el valor de no etiqueta
	**/
    public static final String NO_LABEL="";
	/**
	* identificador en el properties de donde se obtendra la etiqueta.
	**/
    String key();
	/**
