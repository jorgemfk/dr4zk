 ...
 *
 * <br/>
 * Anotacion que define el comportamiento de un contenedor Groupbox
 * @author Jorge Luis Martinez Ramirez
 * @version 1.0
 * @since 13/08/2012
 * @since v0.5
...
public @interface DRGroupBox {
     /**
	 * estilos de dibujar el groupbox
	 **/
     public static enum MOLD {DEFAULT,_3D};
	 /**
	 * anchura en pixeles.
	 **/
     String width();
	 /**
	 * Define si caja al pinstarse estara abierta o cerrada.
	 **/
